...
| Loader | Typical use |
| --- | --- |
| Fabric | Lightweight mods and fast version updates |
| Forge | Large content mods and older modpacks |
| Quilt | Fabric-compatible ecosystem with its own tooling |

## Installation checklist

1. Confirm the Minecraft version.
2. Confirm the required mod loader and loader version.
